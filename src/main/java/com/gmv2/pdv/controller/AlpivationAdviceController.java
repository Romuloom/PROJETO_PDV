...
public class AlpivationAdviceController {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ResponseDTO handleInvalidOperationException(NoItemException ex){
        String messageError = ex.getMessage();
        return new ResponseDTO(messageError);
    }
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ResponseDTO handleValidOperationExceptions(MethodArgumentNotValidException ex){
